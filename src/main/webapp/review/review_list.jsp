...
<h6 style="color:red; text-align: center;">주의! 사용자들에게 실제 노출되는 후기입니다. <sub>*8개 유지 권장</sub></h6>
...
<tr>
   ...
   <td class="col-3 tableTitle">관리</td>
</tr>
<%
for(int i=0; i<reviewList.size(); i++){
	String str1 = reviewList.get(i).getReview_contents();
