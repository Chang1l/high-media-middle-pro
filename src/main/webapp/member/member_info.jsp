		...
		<form name="joinform" class="form-horizontal"
			...
			<div class="form-group row">
				<div class="col-md-5" style="float: none; margin:0 auto;"><h5>*주소</h5>
					<input type="text" name="m_zip" id="sample3_postcode" placeholder="우편번호" class="form-control smStyle" value="${member.m_ZIP}" autocomplete='off' required>
					 <input type="button" style="margin-bottom: 5px;" class="btn btn-primary" onclick="sample3_execDaumPostcode()" value="우편번호"><br>
					<input type="text" name="m_addr" style="margin-bottom: 5px;" id="sample3_address" placeholder="주소" class="form-control sm4Style" autocomplete='off' value="${fn:split(member.m_ADDR, '/')[0]}" required> 
						<input type="text" name="m_addr_sub" id="sample3_detailAddress" placeholder="상세주소" class="form-control sm1Style" value="${fn:split(member.m_ADDR, '/')[1]}" autocomplete='off' required> 
			...
			<div class="form-group row">
				<div class="col-md-5" style="float: none; margin:0 auto;">
					...
					<input type="date" name="m_birth" value="${member.m_BIRTH }"
						class="form-control" min="1900-01-01" max="2022-09-30">
				</div>
			</div><br>
